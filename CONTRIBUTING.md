# Contributing to ngx-lite

We would love for you to contribute to ngx-lite and help make it even better than it is
...
You can file new issues by filling out our [new issue form](https://github.com/coryrylan/ngx-lite/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/coryrylan/ngx-lite/pulls) for an open or closed PR
  that relates to your submission. You don't want to duplicate effort.
1. Be sure that an issue describes the problem you're fixing, or documents the design for the feature you'd like to add.
  Discussing the design up front helps to ensure that we're ready to accept your work.
1. Fork the coryrylan/ngx-lite repo.
...
1. In GitHub, send a pull request to `ngx-lite:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the ngx-lite test suites to ensure tests are still passing.
